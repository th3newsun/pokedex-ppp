...
import { formatStats, getEvolutions, formatTypes, formatAbilities, getPokemonDescription, getImageByPokemon } from "../helpers/pokemon";
...
const PokemonProvider = ({ children }) => {
    ...
    const closePokemonDetail = () => setShowDetailPokemon(false);
