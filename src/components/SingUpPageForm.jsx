  ...
  return (
    <section>
      ...
      <div className='bg-white col-start-2 w-full p-7'>
        ...
        <input type="password" name="password" placeholder="Senha" required className="appearance-none font-outfit border border-gray-400 rounded w-full h-[54px] py-5 px-4 text-gray-700 focus:outline-none" />
        <div className="flex justify-center">
          <button type="submit" className="bg-blue-600 hover:bg-blue-500 text-white text-lg font-bold font-outfit py-3 px-14 mt-7 rounded focus:outline-none focus:shadow-outline">Criar conta</button>
        </div>
      </div>
